...
* Pour le SpamAlyzer, lxml est nécessaire. Très simple a installé sur les systèmes UNIX. Un peu tricky a installé sur Windows, je conseille de passer sur Anaconda et de ne pas se prendre la tête. Sinon ``pip install lxml``.
